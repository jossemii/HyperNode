...
if __name__ == "__main__":
    ...
    l.LOGGER('COMPUTE POWER RATE -> ', COMPUTE_POWER_RATE)
    l.LOGGER('COST OF BUILD -> ', COST_OF_BUILD)
    l.LOGGER('EXECUTION BENEFIT -> ', EXECUTION_BENEFIT)
    l.LOGGER('IGNORE FATHER NETWORK ON SERVICE BALANCER -> ', IGNORE_FATHER_NETWORK_ON_SERVICE_BALANCER)
    l.LOGGER('SEND ONLY HASHES ASKING COST -> ', SEND_ONLY_HASHES_ASKING_COST)
    l.LOGGER('DENEGATE COST REQUEST IF DONT VE THE HASH -> ', DENEGATE_COST_REQUEST_IF_DONT_VE_THE_HASH)
