...
_HASHWITHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='sysreq', full_name='gateway.HashWithConfig.sysreq', index=2,
...
_SERVICEWITHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='sysreq', full_name='gateway.ServiceWithConfig.sysreq', index=2,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_HASHWITHCONFIG.fields_by_name['sysreq'].message_type = celaut__pb2._SYSINFO
...
_SERVICEWITHCONFIG.fields_by_name['sysreq'].message_type = celaut__pb2._SYSINFO
