...
_GATEWAY = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='ModifyServiceSystemParams',
    full_name='gateway.Gateway.ModifyServiceSystemParams',
    index=3,
    containing_service=None,
    input_type=buffer__pb2._BUFFER,
    output_type=buffer__pb2._BUFFER,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='gateway.Gateway.GetSystemParams',
    index=4,
    containing_service=None,
    input_type=buffer__pb2._BUFFER,
    output_type=buffer__pb2._BUFFER,
