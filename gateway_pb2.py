...
_SERVICEWITHCONFIG.fields_by_name['service'].message_type = ipss__pb2._SERVICE
_SERVICEWITHCONFIG.fields_by_name['config'].message_type = ipss__pb2._CONFIGURATION
