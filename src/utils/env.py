...
WEIGHT_CONFIGURATION_FACTOR = GET_ENV(env='WEIGHT_CONFIGURATION_FACTOR', default=pow(10, 9))
...
EXTERNAL_COST_TIMEOUT = GET_ENV(env='EXTERNAL_COST_TIMEOUT', default=600)
