...
_SYSINFO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='ram_space', full_name='celaut.Sysinfo.ram_space', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='ram_frecuency', full_name='celaut.Sysinfo.ram_frecuency', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='disk_space', full_name='celaut.Sysinfo.disk_space', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='disk_frecuency', full_name='celaut.Sysinfo.disk_frecuency', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='cpu_frecuency', full_name='celaut.Sysinfo.cpu_frecuency', index=4,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_ram_space', full_name='celaut.Sysinfo._ram_space',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_ram_frecuency', full_name='celaut.Sysinfo._ram_frecuency',
      index=1, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_disk_space', full_name='celaut.Sysinfo._disk_space',
      index=2, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_disk_frecuency', full_name='celaut.Sysinfo._disk_frecuency',
      index=3, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_cpu_frecuency', full_name='celaut.Sysinfo._cpu_frecuency',
...
_SYSINFO.oneofs_by_name['_ram_space'].fields.append(
  _SYSINFO.fields_by_name['ram_space'])
_SYSINFO.fields_by_name['ram_space'].containing_oneof = _SYSINFO.oneofs_by_name['_ram_space']
_SYSINFO.oneofs_by_name['_ram_frecuency'].fields.append(
  _SYSINFO.fields_by_name['ram_frecuency'])
_SYSINFO.fields_by_name['ram_frecuency'].containing_oneof = _SYSINFO.oneofs_by_name['_ram_frecuency']
_SYSINFO.oneofs_by_name['_disk_space'].fields.append(
  _SYSINFO.fields_by_name['disk_space'])
_SYSINFO.fields_by_name['disk_space'].containing_oneof = _SYSINFO.oneofs_by_name['_disk_space']
_SYSINFO.oneofs_by_name['_disk_frecuency'].fields.append(
  _SYSINFO.fields_by_name['disk_frecuency'])
_SYSINFO.fields_by_name['disk_frecuency'].containing_oneof = _SYSINFO.oneofs_by_name['_disk_frecuency']
_SYSINFO.oneofs_by_name['_cpu_frecuency'].fields.append(
  _SYSINFO.fields_by_name['cpu_frecuency'])
_SYSINFO.fields_by_name['cpu_frecuency'].containing_oneof = _SYSINFO.oneofs_by_name['_cpu_frecuency']
...
Sysinfo = _reflection.GeneratedProtocolMessageType('Sysinfo', (_message.Message,), {
  'DESCRIPTOR' : _SYSINFO,
  '__module__' : 'celaut_pb2'
  # @@protoc_insertion_point(class_scope:celaut.Sysinfo)
  })
