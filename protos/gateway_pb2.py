...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_COMBINATIONRESOURCES_CLAUSEENTRY']._loaded_options = None
  _globals['_COMBINATIONRESOURCES_CLAUSEENTRY']._serialized_options = b'8\001'
  ...
  _globals['_GATEWAY']._serialized_end=2665
